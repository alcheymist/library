...
function page_home(input_){
    ...
    //
    //
    //remove the menu function after adding bootstrap layout to mutall_data
...
//    //
    ...
    this.edit_page_ex = function (result) {
        ...
        switch(result.status){
            ...
            case "ok":
                ...
                var div = document.querySelector("record>div>children");
                //
    ...
    this.save = function(mydiv){
        ...
        var parent = mydiv.parentNode.parentNode;
