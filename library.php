...
class page_home extends page {
    ...
    //Display the mutall identifiers on mutall identity
     function display_identifiers() {
        ...
        $xsl = new DOMDocument;
        $xsl->load('../library/identifiers.xsl');
        //
...
//        $new_proc = $proc->transformToXml($xml);
    ...
    function select_page ($id=null, $children=null){
        ...
        echo "
            <div class='editors'>
        <button class='editors' onclick='$this->website.edit_page(this)'>Edit</button>
        <button class='editors' onclick='$this->website.insertrecord(this, 1)'>Insert Above</button>
        <button class='editors' onclick='$this->website.insertrecord(this, 3)'>Insert Below</button>
        <button class='editors' onclick='$this->website.save(this)'>Save</button>
        <button class='editors' onclick='$this->website.discard(this)'>Discard</button>
        <button class='editors' onclick='$this->website.delete(this)'>Delete</button>
        <children>
        $children
        </children>
        </div>";
...
//The xml driver is the source of data for the home page of a website
