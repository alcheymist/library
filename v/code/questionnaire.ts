...
type Args = any[];
//
//The data to be stored in teh database, specified as an expression. An expression may be:-
type expression = 
    //
    //...a basic Typescript value...
    basic_value
    //
    //...or a tuple that has a function name and arguments. The name is a 
...
type table = {
    ...
    //csv:A table whose bodoy is derived from a csv file
