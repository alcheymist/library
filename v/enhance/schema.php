...
class mutall {
    ...
    //
    //This is a scaled down version of parsing default values
    //in a mysql database.
    static function parse_default(string $default):expression{
        //
        //Special cases of default values referes to inbuilf functions, i.e.,
...
//An operand is an expression that can take part in output operations. It was
//designed to suppot the questionnnaire class for large ladata loading
interface operand{
    //
    //An operand must be simplifiale to get answer
...
class table extends entity {
    ...
    //
    //This constructor is designed to be called from javascript
    // The entity constructor requires:- both mandatory
    // a) the entity name 
    // b) the parent database name 
    function __construct(
    ...
    function get_dependency(): ?int {
        ...
        //
        //Execute the network using the current option for throwing execption
...
//This is the simplest form of an expression. It is encounterer
...
class scalar implements expression, answer, operand {
    //
    //Copy implementstions from the root scalar trait
    use \scalar_trait;
    //
